...
namespace CalendarioSignos
{
    class InterpretadorSigno
    {
        ...
        {
            signos[0] = new Signo { diaInicio = 20, mesInicio = 1, diaFim = 18, mesFim = 2, nome = "Aquario", caracteristicas = "Aquario nos ensina a amizade, a fraternidade, a originalidade, a inovacao, o respeito as diferencas, o amor incondicional ao ser humano e a natureza. Liberdade e a palavra de Aquario." }; signos[1] = new Signo { diaInicio = 19, mesInicio = 2, diaFim = 20, mesFim = 3, nome = "Peixes", caracteristicas = "Peixes nos ensina a fe, a conexao com uma dimensao superior, a simplicidade, o desprendimento, a entrega a vida. Aceitacao e a palavra de Peixes." };
            signos[2] = new Signo { diaInicio = 21, mesInicio = 3, diaFim = 19, mesFim = 4, nome = "Aries", caracteristicas = "Aries nos ensina a coragem, a lideranca, o impulso, a motivacao para iniciar projetos e seguir em frente, mesmo com obstaculos. Superacao e a palavra de Aries." }; signos[3] = new Signo { diaInicio = 20, mesInicio = 4, diaFim = 20, mesFim = 5, nome = "Touro", caracteristicas = "Touro nos ensina o cuidado, o carinho, a paciencia para observar, ver crescer, acompanhar o proprio processo de desenvolvimento e o crescimento de outros. Persistencia e a palavra de Touro." };
